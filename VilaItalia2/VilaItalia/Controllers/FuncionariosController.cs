...
namespace VilaItalia.Controllers
{
    public class FuncionariosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "FuncionarioId,Nome,Telefone,Celular,CPF,Dia_Aniversario,Mes_Aniversario,Ano_Aniversario,Email,CEP,Bairro,Rua,Cidade,Complemento,Referencia,Observacao,Função")] Funcionario funcionario)
        {
